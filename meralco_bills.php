<?php
    include('meralco_bills_action.php');
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="meralco_bills.css">
...
<nav>
    ...
    <div class="wrapper">
        <form action="meralco_bills.php" method="post">
            <h2>Pay Meralco Bills</h2>
