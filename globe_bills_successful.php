<?php
    ...
    include('idle_time.php');
        ...
        if (!isset($_SESSION['globe_bills_successful'])) {
            header('location: globe_bills.php');
        }
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="globe_bills_successful.css">
...
<nav>
    ...
    <div class="wrapper">
        <form action="globe_bills_successful.php" method="post">
