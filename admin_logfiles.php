...
<meta charset="UTF-8">
    ...
    <title>Log Files | Gentlemen's National Bank</title>
    <link rel="stylesheet" type="text/css" href="admin_logfiles.css">
</head>
<body>
<nav>
    <div class="gnblogo">
    <a href="admin_home.php"><img src="images/GNBLOGOW.png" alt="gnb"></a>
        ...
        <ul class="nav-links">
            ...
            <li><a class="active" href="admin_logfiles.php">ADMIN LOGFILES</a></li>
...
<div class="wrapper">
    <form action="logfiles.php" method="post">
        <?php
                $query_admin = "SELECT admin_user, action, date FROM admin_logfile";
                $result = mysqli_query($db, $query_admin);
                    if ($result->num_rows > 0){ ?>
                        <table id="logfiles_admin">
