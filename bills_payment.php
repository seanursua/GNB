...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="bills_payment.css">
...
<nav>
    ...
    <div class="content">
        <div class="globe">
            ...
            <a href="globe_bills.php">Pay Bills to Globe</a>
        </div>
        <div class="meralco">
            <img src="images/meralco.png" alt="globe">
            <a href="meralco_bills.php">Pay Bills to Meralco</a>
        </div>
    </div>
