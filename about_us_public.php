...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="about_us_public.css">
...
<nav>
    ...
    <ul class="nav-links">
        ...
        <li><a class="active" href="about_us_public.php">ABOUT</a></li>
        <li><a href="contact_public.php">CONTACT</a></li>
